...
func init() {
	model.Message_creators[MSG_OFFLINE_V4] = func() model.IMessage { return new(OfflineMessage4) }
	model.Message_creators[MSG_OFFLINE_V3] = func() model.IMessage { return new(OfflineMessage3) }
	model.Message_creators[MSG_OFFLINE_V2] = func() model.IMessage { return new(OfflineMessage2) }
	model.Message_creators[MSG_PENDING_GROUP_MESSAGE] = func() model.IMessage { return new(PendingGroupMessage) }
	model.Message_creators[MSG_GROUP_IM_LIST] = func() model.IMessage { return new(GroupOfflineMessage) }
	model.Message_creators[MSG_GROUP_ACK_IN] = func() model.IMessage { return new(model.IgnoreMessage) }

	model.Message_creators[MSG_OFFLINE] = func() model.IMessage { return new(OfflineMessage1) }
	model.Message_creators[MSG_ACK_IN] = func() model.IMessage { return new(model.IgnoreMessage) }

	model.Message_creators[MSG_STORAGE_SYNC_BEGIN] = func() model.IMessage { return new(SyncCursor) }
	model.Message_creators[MSG_STORAGE_SYNC_MESSAGE] = func() model.IMessage { return new(EMessage) }
	model.Message_creators[MSG_STORAGE_SYNC_MESSAGE_BATCH] = func() model.IMessage { return new(MessageBatch) }

	model.Message_descriptions[MSG_STORAGE_SYNC_BEGIN] = "MSG_STORAGE_SYNC_BEGIN"
	model.Message_descriptions[MSG_STORAGE_SYNC_MESSAGE] = "MSG_STORAGE_SYNC_MESSAGE"
	model.Message_descriptions[MSG_STORAGE_SYNC_MESSAGE_BATCH] = "MSG_STORAGE_SYNC_MESSAGE_BATCH"

	model.Message_descriptions[MSG_OFFLINE_V4] = "MSG_OFFLINE_V4"
	model.Message_descriptions[MSG_OFFLINE_V3] = "MSG_OFFLINE_V3"
	model.Message_descriptions[MSG_OFFLINE_V2] = "MSG_OFFLINE_V2"
	model.Message_descriptions[MSG_PENDING_GROUP_MESSAGE] = "MSG_PENDING_GROUP_MESSAGE"
	model.Message_descriptions[MSG_GROUP_IM_LIST] = "MSG_GROUP_IM_LIST"
}
...
func (emsg *EMessage) ToData() []byte {
	...
	model.WriteMessage(mbuffer, emsg.Msg)
...
func (emsg *EMessage) FromData(buff []byte) bool {
	...
	//recusive
	msg := model.ReceiveMessage(mbuffer)
	if msg == nil {
		return false
	}
	emsg.Msg = msg
...
func (batch *MessageBatch) FromData(buff []byte) bool {
	...
	batch.msgs = make([]*model.Message, 0, count)
	for i := 0; i < int(count); i++ {
		msg := model.ReceiveMessage(buffer)
		if msg == nil {
			return false
		}
